...
var Engine = (function(global) {
  ...
  * When gameState changes init() is called again.
  */
  function main() {
  ...
  */
  ...
  /*
  * This function is called when the game state is new. It will go until
  * an avatar is picked, then call the init() function.
  */
  ...
  /*
  * This function is called when the game state is over. It will go until
  * the game state changes, then call the init() function.
  */
  function gameOver() {
  ...
  */
  for (row = 0; row < numRows; row++) {
    for (col = 0; col < numCols; col++) {
      ...
      */
      ctx.drawImage(Resources.get(rowImages[row]), col *
      101, row * 83);
    }
  }
  renderEntities();
...
/* This function checks what the game state is, and call appropriate
* functions for selectin an avatar, playing the game, or end of game.
*/
function reset() {
